...
class BaseNode:
    ...
    def __init__(self, variable_pool: VariablePool, previous_node_id: str, node_data: Mapping[str, Any], device_id:str, operate:int):
    ...
    def run(self) -> NodeRunResult | None:
        node_run_result = NodeRunResult(self.node_data["id"], self.node_data["node_type"], self.node_data["node_title"], False, None, None, None)
