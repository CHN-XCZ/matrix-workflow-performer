...
from ...workflow_runner.variables.variable_pool import VariablePool
...
class ConditionProcessor:
    def process_conditions(
        ...
        for condition in conditions:
            variable = variable_pool.get(("run_outputs", condition.variable_selector[0], condition.variable_selector[1]))
            if variable is None:
            ...
            #     )
            # else:
            actual_value = variable if variable else None
